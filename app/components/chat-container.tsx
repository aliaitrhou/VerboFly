...
const ChatContainer: React.FC<Props> = ({ children, gptMessages }) => {
  ...
  return (
    <section className="w-full px-6 py-8 rounded-lg border-black border-4">
      <div ref={refContainer} className="flex flex-col bg-white  text-black overflow-auto h-[350px] font-semibold">
        {
